  ...
  return (
    <div className='menu-nav'>
      <div className='menu-nav-top'>
        ...
        <Button variant="link" key='4' value='4' onClick={props.handleClick}>Chef's Choice</Button>
        <Button variant="link" key='5' value='5' onClick={props.handleClick}>Sushi</Button>
        <Button variant="link" key='6' value='6' onClick={props.handleClick}>Tempura Plates</Button>
        <Button variant="link" key='7' value='7' onClick={props.handleClick}>Combination Plates</Button>
      </div>
